...
var url='mongodb://launchcode:karthik9@ds143778.mlab.com:43778/db-kar';//1.Modify this url with the credentials of your db name and password.
...
var deleteDocument = function(db, id, callback) {
    db.collection('books').deleteOne( {_id : new mongo.ObjectId(id)}, function(err, result) {
        ...
        console.log("Deleted a document into the books collection.");
        callback();
    });
};
