        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                ...
                if(result.get(0).contains("thank you")|| result.get(0).contains("u") || result.get(0).contains("you")){
                    TTS.Speak("Thank you too, Karthik Take care");
                    mVoiceInputTv.append(Html.fromHtml("<font color=green>Thank you too, Karthik Take care</font><br>"));
                }
                if(result.get(0).contains("medicine")){

                    TTS.Speak("I think you have fever. Please take medicine");

                    mVoiceInputTv.append(Html.fromHtml("<font color=green>I think you have fever. Please take medicine</font><br>"));
                }
